...
def transform_single_subset_into_batches(data_path: str, subset_dir_name: str):
    """
...
def transform_data_into_batches(data_path: str) -> None:
    """
    ...
    """
    for subset_dir_name in os.listdir(data_path):
